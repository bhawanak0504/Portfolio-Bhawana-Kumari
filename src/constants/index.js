...
export const myProjects = [
  ...
  {
    title: 'Figma-app',
    desc: 'Figma-App is a user-centric platform designed to support expecting mothers throughout their pregnancy journey. With a focus on providing personalized health tracking, educational resources, and mental well-being tools, the app empowers users to monitor their health and stay informed during maternity. The interface offers an intuitive experience, ensuring that mothers can easily access vital information.',
    subdesc:
      'the Figma-App of Maternity and Health integrates modern design practices to create a seamless, aesthetically pleasing experience. Its responsive design ensures accessibility across all devices, while health and wellness features can be tailored to individual needs, offering ongoing support before and after.',
    href: 'https://www.figma.com/design/pkyTPrtSwS1htlrqv2lW6P/Maternity-%26-Baby-hub?node-id=0-1&node-type=canvas',
